              ...
              <div className="media block-6 services d-block text-center">
                ...
                <div className="media-body p-2 mt-3">
                  ...
                  <p>
                    ...
                    студенты работали онлайн с тренерами и командой IT-Академии;
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
              <div className="media block-6 services d-block text-center">
                ...
                <div className="media-body p-2 mt-3">
                  ...
                  <p>
                    сессия и выпускные экзамены. Лекции и семинары по социальным
                    навыкам от партнеров КАРПОУ. Выпускники, успешно сдавшие
                    экзамены, получили сертификаты от IT отрасли.
                  </p>
                </div>
              </div>
            </div>
