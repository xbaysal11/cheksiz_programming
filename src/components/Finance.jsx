            ...
            <div className="row d-flex justify-content-center">
              <div className="col-md-7 text-center heading-section heading-section-white ftco-animate">
                ...
                <p>
                  ...
                  организаторов: выезд из г. Бишкек до мест проведения учебы, а
                  также питание и проживание в местах обучения. Участники должны
                  были сами покрыть транспортные расходы до г. Бишкек и расходы
                  на подключение к интернету дома. <br />
